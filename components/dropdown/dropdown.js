document.addEventListener("alpine:init", () => {
  Alpine.data("dropdown", () => ({
    style: {
      wrapper: "relative",
      trigger:
        "bg-blue-400 text-white px-4 py-2 rounded-lg font-semibold hover:brightness-110 flex items-center whitespace-nowrap",
      menu: {
    ...
    init() {
      ...
      triggerElement.className = style.trigger;
